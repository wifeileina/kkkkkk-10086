import { Base, baseHeaders, Common, Config, downloadFile, mergeFile, Render, uploadFile, Version, processImageUrl, makeForwardMsgBatched, MAX_FORWARD_MESSAGES } from '../../utils/index.js'
                ...
                switch (dynamicItem.dynamic_type) {
                  ...
                  case 'DYNAMIC_TYPE_DRAW': {
                    ...
                    if (Version.BotName === 'Miao-Yunzai') {
                      ...
                      forwardList.push(...await makeForwardMsgBatched(Bot?.[botId], imgArray, '动态图片'))
                    }
